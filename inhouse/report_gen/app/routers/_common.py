...
3. **HTTP 상태 코드는 11종 전부 항상 200**이다 — 성공/실패 구분은 바디의
...
from ..analysis.report_render import build_key_metrics_table, render_plain_report
...
# 11종 엔드포인트가 공유하는 실행 풀 — 요청마다 새 스레드를 만들지 않는다.
