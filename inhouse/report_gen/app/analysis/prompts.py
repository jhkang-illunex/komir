...
- supply_key_factors(있으면, major_changes) — 국내 수입증가율(전년 대비
  ...
  변동이 수급동향지표 변화와 함께 확인된다"는 주어·어투로 옮겨 쓰고,
  "수입증가율이 X% 감소했다"처럼 증가율 자체가 줄었다는 식으로 바꿔 쓰지
  않는다. 2026-09-09 발주처 업무지시서 §2.2 대응으로 이 근거는 "주요
  요인으로는 ... 분석된다"는 인과 단정 표현을 뺐다 — "원인"·"요인"·
  "분석된다"는 말을 되살려 쓰지 않는다. 수입국
...
- major_changes는 import_concentration 근거를 그대로 쓴다 — "수입
  ...
  문장 대신 "조회가 {국가} 한 국가로 한정돼 있어 ... 전체 금액이다"류
