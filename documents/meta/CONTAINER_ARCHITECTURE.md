...
>
> **⚠ 경로 주의(2026-09-07 services/ 해체)**: 이 문서의 `services/...` 경로와
> "`services/shared`→`./shared` 평탄화 COPY" 서술은 작성 시점 기준 역사 기록이다.
> 현재는 `services/`가 없어지고 `common/`(구 shared 공용부)·`rag/retrieval`(구 shared
