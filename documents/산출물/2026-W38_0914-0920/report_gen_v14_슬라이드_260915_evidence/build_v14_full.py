...
path_v13 = glob.glob(f"{PPTX_DIR}/*v13.pptx")[0]  # 대조 기준(손대지 않음)
path_v12 = path_v10.replace("v10", "v14")
...
R = load("documents/산출물/2026-W38_0914-0920/report_gen_v14_슬라이드_260915_evidence/v14_sources.json")
