...
path_v13 = glob.glob(f"{PPTX_DIR}/*v14.pptx")[0]  # 대조 기준 = v14(손대지 않음; 변수명은 v13 스크립트 호환)
path_v12 = path_v10.replace("v10", "v15")
...
R = load("documents/산출물/2026-W38_0914-0920/report_gen_v15_슬라이드_260915_evidence/v15_sources.json")
...
p.save(path)
print("v15.pptx 저장 완료:", path, "| 슬라이드", len(p.slides), "| 적색 표시", len(changed), "곳 | 템플릿 잔존 적색→흑색", cleared, "run")
for item in changed:
    print("  ", item)
