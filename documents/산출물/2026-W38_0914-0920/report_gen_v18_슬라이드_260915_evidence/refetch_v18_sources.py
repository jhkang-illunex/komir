...
def run(key, page_id, **kwargs):
    req = AnalysisSummaryRequest(request_id=f"v18-{key}", page_id=page_id, **kwargs)
...
json.dump(out, open("documents/산출물/2026-W38_0914-0920/report_gen_v18_슬라이드_260915_evidence/v18_sources.json", "w", encoding="utf-8"), ensure_ascii=False, indent=2)
