...
| `documents/산출물/2026-W30_0720-0726/챔피언_스코어보드_260725.md` | 기존 vs 신생 챔피언 총괄 스코어보드(발주처 보고용 정리) — 진단 Δ 보팅 Bag+Bag·예측 ExtraTrees(ton/unit)·지수 CO x_z13, 재발행 강건성 판정 포함, 운영 반영 대기 목록 | WORKLOG 2026-07-25(최신㉒), 스코어카드 v1.16 |
