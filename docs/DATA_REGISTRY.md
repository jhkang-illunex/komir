...
| `mineral_supply_risk/outputs/model_opt/r10_retune_report.md` | **R10 전면 재검정 최신판(260729)** — ARCA 백필(41행)·Census(2,864행)·BPS(484행) 반영 후 신규 SERIES_SPEC 11건 스크리닝+부트스트랩+예측exog 검정. 채택 0건, id_ni·us_ni 방향긍정 보류 추가, 챔피언 불변. 직전판은 `r10_retune_report_260728.md` 보존 | 사용자 요청(2026-07-29), WORKLOG 최신㊹ |
