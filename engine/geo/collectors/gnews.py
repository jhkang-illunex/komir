# -*- coding: utf-8 -*-
"""[0] Google News RSS 뉴스 수집 → geo_data/inbox 텍스트 투척 (komis/collectors/gnews.py 이식).
...
logger = logging.getLogger("geo.collectors.gnews")
...
def run(minerals: list[str] | None = None, days: int = 90) -> int:
    ...
    save_seen(seen)
    print(f"[gnews] inbox 신규 투척 {total}건 → geo_data/inbox/gnews/ "
