...
- 생성: 2026-07-12. 갱신: 2026-07-25(보조 신호 노출) → 2026-07-27(SHFE CU 재고 복구
  반영 aux v2 재발행분으로 재생성 — NI 조기경보 상향→하향 등 신호 변경, WORKLOG 최신㊱).
  발행: https://claude.ai/code/artifact/a6179ec1-bdc3-4377-9786-d160aa85c16c
