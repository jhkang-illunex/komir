...
# 2026-08-06 dmz/ 물리분리 이관: 상대임포트 깊이 수정(`..config`→`.config`, customs_api.py와
# 동일 사유 — 구 경로 msr/collectors/에서는 부모가 msr였으나 신 경로 dmz/msr_collectors/에서는
# 부모가 dmz.msr_collectors 자신).
